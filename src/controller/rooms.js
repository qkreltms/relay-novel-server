module.exports = (conn) => {
  ...
  api.get('/all', (req, res) => {
    ...
    const runQuery = async (errHandlerCallback) => {
      try {
        const sql = `SELECT id, writerLimit, tags, title, 'desc', creatorId, updatedAt, createdAt, like FROM rooms ORDER BY createdAt DESC LIMIT ${skip}, ${limit}`
  ...
  api.get('/', (req, res) => {
    ...
    const runQuery = async (errHandlerCallback) => {
      try {
        const sql = `SELECT id, writerLimit, tags, title, 'desc', updatedAt, createdAt, like FROM rooms WHERE creatorId = ? ORDER BY createdAt DESC LIMIT ${skip}, ${limit}`
